...
! USE twoway_met_param_module
  ...
  INTEGER, INTENT(IN)           :: wrf_cmaq_model_tstep
  ...
  DO kk = 1, nlays
     ...
     DO r = 1, wrf_c_nrows
        ...
        !-----------------------------------------------------------------------
           ...
           metcro3d_data_wrf (c,r,kk,18) = grid%ust_wl(ii,kk,jj)  ! for UACM
...
!-------------------------------------------------------------------------------
        ...
        DO r = 1, wrf_c_nrows
           ...
           DO c = 1, wrf_c_ncols
              ...
              metcro3d_data_wrf (c,r,k,n_metcro3d_var-1) = -1.0e6 * ( vor * dtds(c,r)   &
                                                         - dvds(c,r) * dtdx(c,r)      &
                                                         + duds(c,r) * dtdy(c,r) )    &
...
! add urban variables
  metcro2d_data_wrf (:,:,39) =  grid%build_area_fraction  (tw_sc:tw_ec, tw_sr:tw_er)
  metcro2d_data_wrf (:,:,40) =  grid%build_height (tw_sc:tw_ec, tw_sr:tw_er)
  metcro2d_data_wrf (:,:,41) =  grid%blkw1 (tw_sc:tw_ec, tw_sr:tw_er)
  metcro2d_data_wrf (:,:,42) =  grid%blkw2 (tw_sc:tw_ec, tw_sr:tw_er)
  metcro2d_data_wrf (:,:,43) =  grid%ust_rf (tw_sc:tw_ec, tw_sr:tw_er)
  metcro2d_data_wrf (:,:,44) =  grid%gab_rf (tw_sc:tw_ec, tw_sr:tw_er)
